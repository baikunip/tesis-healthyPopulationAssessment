<script>
    ...
    map.on("load",()=>{
        ...
        map.on("click",(e)=>{
            ...
            $('#rb-sangat-sehat').html((Math.log(37)-attrgwr["beta_Intercept"])*$('#rb-kontribusi').val()*(attrgwr["beta_X.RB"]/Math.abs(attrgwr["beta_X.RB"])).toFixed(2))
            $('#rb-sehat').html((Math.log(69)-attrgwr["beta_Intercept"])*$('#rb-kontribusi').val()*(attrgwr["beta_X.RB"]/Math.abs(attrgwr["beta_X.RB"])).toFixed(2))
            $('#rb-kurang-sehat').html((Math.log(112)-attrgwr["beta_Intercept"])*$('#rb-kontribusi').val()*(attrgwr["beta_X.RB"]/Math.abs(attrgwr["beta_X.RB"])).toFixed(2))
            // $('#rb-tidak-sehat').html((Math.log(37)-attrgwr["beta_Intercept"])*$('#rb-kontribusi').val()*(attrgwr["beta_X.RB"]/Math.abs(attrgwr["beta_X.RB"])))
            ...
            $('#layair-sangat-sehat').html(100*(Math.log(37)-attrgwr["beta_Intercept"])*$('#layair-kontribusi').val()*(attrgwr["beta_X.Lay.Air"]/Math.abs(attrgwr["beta_X.Lay.Air"])).toFixed(2))
            $('#layair-sehat').html(100*(Math.log(69)-attrgwr["beta_Intercept"])*$('#layair-kontribusi').val()*(attrgwr["beta_X.Lay.Air"]/Math.abs(attrgwr["beta_X.Lay.Air"])).toFixed(2))
            $('#layair-kurang-sehat').html(100*(Math.log(112)-attrgwr["beta_Intercept"])*$('#layair-kontribusi').val()*(attrgwr["beta_X.Lay.Air"]/Math.abs(attrgwr["beta_X.Lay.Air"])).toFixed(2))
